...
export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'dropzone.sub': '或点击选择',
    'dropzone.disabled': '压缩进行中，请稍候',
    'dropzone.add_more': '点击或拖入视频以添加',
    'dropzone.desc': '支持多选，或点击选择文件',
    ...
    'settings.concurrency_all_desc': '使用全部 CPU 核心并发编码',
    ...
    'app.setup_engine_desc': '检测到系统未安装 <strong>FFmpeg</strong> 视频引擎。<br>Videopress 需要该依赖进行视频解码与压缩。',
    'app.setup_downloading': '正在下载核心组件… ({percent}%)',
    'app.setup_download_tip': '请勿关闭软件，完成后将自动进入主界面。',
    'app.setup_btn_auto': '自动下载并配置（推荐）',
    'app.setup_btn_manual': '手动指定路径或查找本地文件',
    ...
    'advanced.video_codec_desc': '选择视频编码格式。自动按硬件推荐编码器；H.265 体积更小，AV1 为较新编码。',
    'advanced.video_codec_auto': '自动（按硬件推荐）',
    ...
    'advanced.audio_mode_desc': '音频处理模式。直通保留原音轨，压缩可减小体积。',
    'advanced.audio_mode_auto': '压缩音频（推荐）',
  ...
  en: {
    ...
    'dropzone.disabled': 'Compression in progress, please wait',
    'dropzone.add_more': 'Click or drop videos to add',
    'dropzone.desc': 'Multi-select supported, or click to choose files',
    ...
    'settings.concurrency_all_desc': 'Use all CPU cores for concurrent encoding',
    ...
    'app.setup_engine_desc': 'FFmpeg is not installed on your system.<br>Videopress requires it for video decoding and compression.',
    'app.setup_downloading': 'Downloading core components… ({percent}%)',
    'app.setup_download_tip': 'Do not close the app. The workspace will open when complete.',
    'app.setup_btn_auto': 'Download and configure (recommended)',
    'app.setup_btn_manual': 'Specify path or locate file manually',
    ...
    'advanced.video_codec_desc': 'Choose video codec. Auto picks an encoder for your hardware. H.265 yields smaller files; AV1 is a newer codec.',
    'advanced.video_codec_auto': 'Auto (hardware-based)',
    ...
    'advanced.audio_mode_desc': 'Audio handling. Copy keeps the original track; compress reduces file size.',
    'advanced.audio_mode_auto': 'Compress audio (recommended)',
