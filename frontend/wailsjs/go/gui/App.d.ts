...
export function CancelGifExport():Promise<void>;
...
export function GetGifFormats():Promise<Array<string>>;

export function GetGifTiers():Promise<Array<gui.GifTierInfo>>;
...
export function GetPresets():Promise<Array<gui.PresetInfo>>;
...
export function StartGifExport(arg1:gif.ExportRequest):Promise<Array<gif.ExportResult>>;
